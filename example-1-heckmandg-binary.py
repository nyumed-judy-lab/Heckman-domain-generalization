...
scheduler = None
from models.heckmandg_regression
...
#%% HeckmanDGClassifierCNN
optimizer = torch.optim.SGD(param_groups, lr=args.lr, weight_decay=args.weight_decay)
model = HeckmanDGClassifierCNN(args, network, optimizer)
model.fit(train_loader, valid_loader)
